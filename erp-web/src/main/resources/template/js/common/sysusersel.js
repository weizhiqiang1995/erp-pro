	...
	layui.use(['form'], function (form) {
	    ...
	    function addToArray(data) {
	    	...
	    	if(!inArray) { //如果该元素在集合中不存在
	    		...
	    		var str = getDataUseHandlebars(peopleTemplate, {bean: j});
	    		$("#selPeopleList").append(str);
	    	}
	    }
	    ...
	    function removeToArray(id) {
	    	...
	    	if(inArray != -1) { //如果该元素在集合中存在
	    		...
	    		$("#selPeopleList").find("div[class='sel-people-item'][rowid='" + id + "']").remove();
	    		$("#selPeopleList").find("div[class='sel-people-item active'][rowid='" + id + "']").remove();
	    	}
	    }
