...
;(function(factory) {
    ...
    editormd.emoji     = {
        path  : reqBasePath + "assets/lib/editormd/plugins/emoji-dialog/emoji/",
        ext   : ".png"
    };
    ...
    editormd.loadCSS   = function(fileName, callback, into) {
        ...
        css.href   = reqBasePath + 'assets/lib/' + fileName + ".css";
    ...
    editormd.loadScript = function(fileName, callback, into) {
        ...
        script.src    = reqBasePath + 'assets/lib/' + fileName + ".js";
    ...
    editormd.katexURL  = {
        css : "editormd/plugins/KaTeX/katex.min",
        js  : "editormd/plugins/KaTeX/katex.min"
    };
