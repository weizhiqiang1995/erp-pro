    ...
    layui.define(['jquery', 'layer', 'element', 'form'], function (exports) {
        ...
        var Winui = function () {
            ...
            this.settings = {
                color: 31,
                taskbarMode: 'bottom',
                bgSrc: fileBasePath + '/images/upload/winbgpic/default.jpg',
                lockBgSrc: fileBasePath + '/images/upload/winlockbgpic/default.jpg/',
        ...
        Winui.prototype = {
            ...
            taskAuto: function () {
                ...
                $('.winui-taskbar-task').each(function () {
                	if($(this).css("display") === 'block'){//判断当前操作的是哪个任务窗口
