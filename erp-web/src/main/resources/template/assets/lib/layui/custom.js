...
dataGrid.prototype = {
	...
	createFoot: function() {
		...
		totalsubpageTmep += "<li class='ali'><a href='javascript:void(0);' class='pageBtn' data-go=''>到第&nbsp;&nbsp;<input type='text' id='pageInput' value='" 
							+ _op.settings.pageindex + "' class='pageInput'/>&nbsp;&nbsp;页<span id='skippage'>确定</span>&nbsp;&nbsp;共&nbsp;&nbsp;"
							+ _op.settings.total + "&nbsp;&nbsp;条</a></li>";
