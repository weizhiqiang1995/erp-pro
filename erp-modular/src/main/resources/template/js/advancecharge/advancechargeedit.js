...
layui.config({
    ...
    layui.use(['form', 'tagEditor'], function(form) {
        ...
        showGrid({
            id: "showForm",
            url: reqBasePath + "advancecharge003",
        ...
        function initDataToShow(){
            $("#organId").val(orderObject.bean.organId);//收款单位
        ...
        form.on('submit(formEditBean)', function(data) {
            ...
            if(winui.verifyForm(data.elem)) {
                ...
                AjaxPostUtil.request({url: reqBasePath + "advancecharge004", params: params, type: 'json', callback: function(json) {
                    if(json.returnCode == 0) {
