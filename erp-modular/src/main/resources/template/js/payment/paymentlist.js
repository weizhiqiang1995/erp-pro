...
layui.config({
    ...
    var $ = layui.$,
        ...
        table = layui.table;
    authBtn('1571811039781');//新增
    authBtn('1572315820815');//导出
    ...
    table.render({
        ...
        cols: [[
            ...
            { field: 'supplierName', title: '收款单位', align: 'left', width: 150},
    ...
    function edit(data){
        rowId = data.id;
        _openNewWindows({
            url: "../../tpl/payment/paymentedit.html",
            title: "编辑",
            pageId: "paymentedit",
            area: ['90vw', '90vh'],
    ...
    function deletepayment(data){
        layer.confirm('确认要删除信息吗？', { icon: 3, title: '删除操作' }, function (index) {
            AjaxPostUtil.request({url:reqBasePath + "payment005", params: {rowId: data.id}, type:'json', callback:function(json){
    ...
    function details(data){
        rowId = data.id;
        _openNewWindows({
            url: "../../tpl/payment/paymentinfo.html",
            title: "详情",
            pageId: "paymentinfo",
            area: ['90vw', '90vh'],
            callBack: function(refreshCode){
    ...
    $("body").on("click", "#addBean", function(){
        _openNewWindows({
            url: "../../tpl/payment/paymentadd.html",
            title: "新增",
            pageId: "paymentadd",
            area: ['90vw', '90vh'],
            callBack: function(refreshCode){
    ...
    $("body").on("click", "#downloadExcel", function () {
    	...
    	postDownLoadFile({
			url : reqBasePath + 'payment007?userToken=' + getCookie('userToken') + '&loginPCIp=' + returnCitySN["cip"],
