 ...
 * @date 2020年8月22日
 */
@Service("mailAccessSendedService")
public class MailAccessSendedServiceImpl implements JobMateService {
    ...
    public void call(String data) {
        ...
        try {
            ...
            //获取当前邮箱已有的邮件
            List<Map<String, Object>> emailHasMail = mqUserEmailDao.queryEmailListByEmailFromAddress(map);
