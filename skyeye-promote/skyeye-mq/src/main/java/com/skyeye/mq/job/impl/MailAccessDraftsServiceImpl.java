...
@RocketMQMessageListener(
    topic = "${topic.mail-access-drafts-service}",
    consumerGroup = "${topic.mail-access-drafts-service}",
    selectorExpression = "${spring.profiles.active}")
public class MailAccessDraftsServiceImpl implements RocketMQListener<String> {
