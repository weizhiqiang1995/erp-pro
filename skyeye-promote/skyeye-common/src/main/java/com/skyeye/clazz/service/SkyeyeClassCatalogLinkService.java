...
/**
 * @ClassName: SkyeyeClassCatalogLinkService
 * @Description: 需要关联目录的服务注册接口层
 * @author: skyeye云系列--卫志强
 * @date: 2022/11/29 22:30
 * @Copyright: 2022 https://gitee.com/doc_wei01/skyeye Inc. All rights reserved.
 * 注意：本内容仅限购买后使用.禁止私自外泄以及用于其他的商业目的
 */
public interface SkyeyeClassCatalogLinkService extends SkyeyeBusinessService<SkyeyeClassCatalogLink> {
